...
@section('title', 'Edit Client'.$client->business_name)
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            {{ Form::open(['route' => ['client.update', $client->id], 'method' =>'PUT', 'class' => 'form-horizontal']) }}
                            ...
                            <div class="col-md-12">
                                <div class="client-block col-lg-12">
                                    ...
                                    <div class="form-group{{ $errors->has('business_name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="business_name" type="text" class="form-control" name="business_name" value="{{ $client->business_name }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('address1') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="address1" type="text" class="form-control" name="address1" value="{{ $client->address1 }}" required>
                                    ...
                                    <strong>{{ $errors->first('address2') }}</strong>
                                        ...
                                        <div class="col-md-12">
                                            <input id="address2" type="text" class="form-control" name="address2" value="{{ $client->address2 }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="state" type="text" class="form-control" name="state" value="{{ $client->state }}" >
                                    ...
                                    <div class="form-group{{ $errors->has('postcode') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="postcode" type="text" class="form-control" name="postcode" value="{{ $client->postcode }}">
                            ...
                            <div class="col-md-12">
                                <div class="client-block col-lg-12">
                                    ...
                                    <div class="form-group{{ $errors->has('years_in_business') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="years_in_business" type="text" class="form-control" name="years_in_business" value="{{ $client->years_in_business }}">
                                    ...
                                    <div class="form-group{{ $errors->has('business_license') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="business_license" type="text" class="form-control" name="business_license" value="{{ $client->business_license }}">
                                    ...
                                    <div class="form-group{{ $errors->has('payment_types_accepted') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="payment_types_accepted" type="text" class="form-control" name="payment_types_accepted" value="{{ $client->payment_types_accepted }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('products_or_brands_offered') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="products_or_brands_offered" type="text" class="form-control" name="products_or_brands_offered" value="{{ $client->products_or_brands_offered }}">
                                    ...
                                    <div class="form-group{{ $errors->has('business_description') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <textarea id="business_description" class="form-control" name="business_description">{{ $client->business_description }}</textarea>
                                    ...
                                    <div class="form-group{{ $errors->has('business_hours') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="business_hours" type="text" class="form-control" name="business_hours" value="{{ $client->business_hours }}">
                            ...
                            <div class="col-md-12">
                                <div class="client-block col-lg-12">
                                    ...
                                    <div class="form-group{{ $errors->has('business_owners_name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="business_owners_name" type="text" class="form-control" name="business_owners_name" value="{{ $client->business_owners_name }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('business_owners_email') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="business_owners_email" type="text" class="form-control" name="business_owners_email" value="{{ $client->business_owners_email }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('business_owners_phone') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="business_owners_phone" type="text" class="form-control" name="business_owners_phone" value="{{ $client->business_owners_phone }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('business_owners_fax') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="business_owners_fax" type="text" class="form-control" name="business_owners_fax" value="{{ $client->business_owners_fax }}">
                                    ...
                                    <div class="form-group{{ $errors->has('business_owners_phone1') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="business_owners_phone1" type="text" class="form-control" name="business_owners_phone1" value="{{ $client->business_owners_phone1 }}">
                                    ...
                                    <div class="form-group{{ $errors->has('business_website') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="business_website" type="text" class="form-control" name="business_website" value="{{ $client->business_website }}">
                            ...
                            <div class="col-md-12">
                                <div class="client-block col-lg-12">
                                    ...
                                    <div class="form-group{{ $errors->has('keywords') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <textarea id="keywords" class="form-control" name="keywords">{{ $client->keywords }}</textarea>
                                    ...
                                    <div class="form-group{{ $errors->has('logo_url') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="logo_url" type="text" class="form-control" name="logo_url" value="{{ $client->logo_url }}">
                                    ...
                                    <div class="form-group{{ $errors->has('photo_url1') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="photo_url1" type="text" class="form-control" name="photo_url1" value="{{ $client->photo_url1 }}">
                                    ...
                                    <div class="form-group{{ $errors->has('photo_url2') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="photo_url2" type="text" class="form-control" name="photo_url2" value="{{ $client->photo_url2 }}">
                                    ...
                                    <div class="form-group{{ $errors->has('photo_url3') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="photo_url3" type="text" class="form-control" name="photo_url3" value="{{ $client->photo_url3 }}">
                                    ...
                                    <div class="form-group{{ $errors->has('photo_url4') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="photo_url4" type="text" class="form-control" name="photo_url4" value="{{ $client->photo_url4 }}">
                                    ...
                                    <div class="form-group{{ $errors->has('photo_url5') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="photo_url5" type="text" class="form-control" name="photo_url5" value="{{ $client->photo_url5 }}">
                                    ...
                                    <div class="form-group{{ $errors->has('social_accounts') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <textarea id="social_accounts" class="form-control" name="social_accounts">{{ $client->social_accounts }}</textarea>
                                    ...
                                    <div class="form-group{{ $errors->has('citations') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <textarea id="citations" class="form-control" name="citations">{{ $client->citations }}</textarea>
                                    ...
                                    <div class="form-group{{ $errors->has('website_login') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input id="website_login" type="text" class="form-control" name="website_login" value="{{ $client->website_login }}">
                                    ...
                                    <div class="form-group{{ $errors->has('notes') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <textarea id="notes" class="form-control" name="notes">{{ $client->notes }}</textarea>
