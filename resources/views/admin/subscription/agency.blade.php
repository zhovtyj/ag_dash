    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="orders-buttons-cont">
                <a class="btn btn-primary" href="{{route('admin.subscription.agency.new', $user->id)}}">New Subscriptions</a>
                <a class="btn btn-primary" href="{{route('admin.subscription.agency.active', $user->id)}}">Active Subscriptions</a>
                <a class="btn btn-primary" href="{{route('admin.subscription.agency.completed', $user->id)}}">Completed Subscriptions</a>
            </div>
        </div>
    </div>
    ...
    <div id="breadcrumbs-container">
        <div class="container-small">
            <ol vocab="http://schema.org/" typeof="BreadcrumbList" class="breadcrumbs">
                ...
                <span> › </span>
                <li property="itemListElement" typeof="ListItem">
                    <a property="item" typeof="WebPage" href="{{ route('admin.subscription.agency', $user->id) }}">
