...
@section('title', 'Editing'.$client->business_name)
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            {{ Form::open(['route' => ['admin.client.update', $user->id, $client->id], 'method' =>'PUT', 'class' => 'form-horizontal']) }}
            <div class="row">
                <div class="col-md-6">
    ...
    <div id="breadcrumbs-container">
        <div class="container-small">
            <ol vocab="http://schema.org/" typeof="BreadcrumbList" class="breadcrumbs">
                ...
                <span> › </span>
                <li property="itemListElement" typeof="ListItem">
                    <a property="item" typeof="WebPage" href="{{ route('admin.client.edit', [$user->id, $client->id]) }}">
